...
import com.project.payroll.entities.OrderNotFoundException;
...
public class OrderController {
  ...
  CollectionModel<EntityModel<Order>> all() {
    ...
    return CollectionModel.of(
        orders, linkTo(methodOn(OrderController.class).all()).withSelfRel());
  }
  ...
  ResponseEntity<?> cancel(@PathVariable Long id) {
    ...
    return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
        ...
        .body(Problem.create()
            ...
            .withDetail("You can't cancel an order that is int the " +
  ...
  ResponseEntity<?> complete(@PathVariable Long id) {
    ...
    return ResponseEntity
            ...
            .body(Problem.create()
                  .withTitle("Method not allowed")
            .withDetail("You can't compelte an order that is in the " + order.getStatus() + " status"));
  }
}
